    ...
    if (std::cin){
        ...
        switch (choice) {
            ...
            case 12: {
                ...
                auto end = std::chrono::high_resolution_clock::now();
                auto duration = std::chrono::duration_cast<std::chrono::microseconds>(end - start).count();
                std::cout << rows1 << "x" << columns1 << " and " <<
                rows2 << "x" << columns2 << " " << number_of_bits << " bit Matrix multiplication took " << duration << " microseconds." << std::endl;
                std::cout << rows1 << "x" << columns1 << " and " <<
                rows2 << "x" << columns2 << " " << number_of_bits << " bit Matrix multiplication result:\n " << result << std::endl;
            }
            ...
            case 15: {
                ...
                std::cout << "Matrix created: \n" << m << std::endl;
                std::cout << "Matrix scalonade form: \n" << Matrix::scalonadeForm(m) << std::endl;
            }
        }
    }
        else {
